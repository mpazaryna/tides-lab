    ...
    <View style={styles.container}>
      ...
      <View style={styles.debugSection}>
        ...
        {locationInfo && (
          <>
            <Text variant="bodySmall" color="secondary">
              • Location: {locationInfo.city || 'Unknown'}, {locationInfo.region || 'Unknown'}
            </Text>
            <Text variant="bodySmall" color="secondary">
        ...
        <View style={styles.dailyTideSection}>
          <View style={styles.dailyTideHeader}>
            <View style={styles.dailyTideLeft}>
              ...
              <Text variant="body" color="primary" style={styles.dailyTideTitle}>
                {dailyTide.name}
              </Text>
            </View>
          ...
          {wasCreatedToday && (
            <Text variant="bodySmall" color="secondary" style={styles.newTideNote}>
