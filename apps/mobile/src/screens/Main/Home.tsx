      ...
      <ScrollView style={styles.scrollView}>
        <Container padding={5} style={styles.content}>
          ...
          <Card variant="elevated" padding={4} style={styles.chatCardStyle}>
            ...
            <Text variant="body" color="secondary" style={styles.chatDescriptionStyle}>
              Interact with MCP tools and the TideProductivityAgent through natural language conversations.
            </Text>
            <Button
              variant="primary"
              size="md"
                ...
                >
                  ...
                  <View style={styles.flowTypeContainer}>
                    ...
                    <View style={styles.flowTypeOptions}>
                      {(
                        ["daily", "weekly", "project", "seasonal"] as const
                      ).map((type) => (
                        <TouchableOpacity
                          key={type}
                          style={[
