...
- **[MOBILE]** Tides for Projects are locked for beta (paying customers only) - popup should appear whenever a user clicks a button suggesting them
...
- **[BACKEND]** Debug issue where user gets multiple daily tides when signing in multiple times (evidence in env.006 D1 table)
